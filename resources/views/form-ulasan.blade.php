    ...
    <div class="bg-white p-10 rounded-3xl shadow-xl shadow-pink-100 border border-pink-50">
        ...
        <form action="{{ url('/pengelolaan') }}" method="GET">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="buku" value="{{ $buku }}" readonly class="w-full px-5 py-3 bg-pink-50 border border-pink-200 rounded-2xl text-rose-900 font-bold cursor-not-allowed">
            </div>
